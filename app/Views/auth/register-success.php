...
<head>
  ...
  <style>
    /* Registration success popup styles */
...
<body class="register-success-page">
  ...
  <div class="success-modal">
    ...
    <h1 class="success-title">Welcome to Ulimi!</h1>
    
    <p class="success-message">
      Your account has been created successfully. You're now ready to start trading on the agricultural platform.
    </p>
    ...
    <div class="welcome-features">
      ...
      <ul class="feature-list">
        ...
        <li>Browse available commodities and make offers</li>
        <li>Track your transactions and payments</li>
        <li>Get real-time market insights and alerts</li>
      </ul>
    </div>
