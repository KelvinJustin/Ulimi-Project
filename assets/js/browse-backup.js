...
class ProductManager {
    ...
    async loadProducts() {
        ...
        try {
            const url = `${this.getBaseUrl()}/api/products.php`;
            ...
            <div class="product-card" data-product-id="${product.id}">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        ...
                        <button class="btn-favorite" onclick="productManager.toggleFavorite(${product.id})">
...
class CartManager {
    ...
    loadCartFromStorage() {
        const savedCart = localStorage.getItem('ulimi_cart');
        if (savedCart) {
    ...
    saveCartToStorage() {
        localStorage.setItem('ulimi_cart', JSON.stringify(this.items));
    }
                ...
                const itemsHTML = this.items.map(item => `
                    <div class="cart-item">
                        <div class="cart-item-image">
                            <img src="${item.image || '/assets/images/placeholder-product.jpg'}" alt="${item.title}">
                        </div>
                        <div class="cart-item-details">
                            <h4>${item.title}</h4>
                            <p>MWK ${item.price.toFixed(2)}</p>
                        </div>
